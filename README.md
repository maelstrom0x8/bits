...
## Contents
* [About the operation counting methodology](#i-1)
* [Compute the sign of an integer](#i-2)
* [Detect if two integers have opposite signs](#i-3)
* [Compute the integer absolute value (abs) without branching](#i-4)
* [Compute the minimum (min) or maximum (max) of two integers without branching](#i-5)
* [Determining if an integer is a power of 2](#i-6)
* [Sign extending](#i-7)
    * [Sign extending from a constant bit-width](#i-7-1)
    * [Sign extending from a variable bit-width](#i-7-2)
    * [Sign extending from a variable bit-width in 3 operations](#i-7-3)
* [Conditionally set or clear bits without branching](#i-8)
* [Conditionally negate a value without branching](#i-9)
* [Merge bits from two values according to a mask](#i-10)
* Counting bits set
...
### About the operation counting methodology<span id="i-1"><span>
...
### Compute the sign of an integer<span id="i-2"><span>
```c
